...
class TestRegistration:
    def test_registration_with_valid_data_succeeds(self, driver, registration_page, user_valid_data_registration, wait, main_page, cabinet_page):
        self.driver = driver
    ...
    def test_registration_with_invalid_password_length_shows_error(self, driver,  create_invalid_password, registration_page):    
        self.driver = driver
        # Открытие страницы регистрации 
        self.driver.get(registration_page)
